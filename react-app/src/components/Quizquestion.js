...
const Quizquestion = ({qui}) => {
    ...
    console.log(ans) 
        ...
        if (ans === qui.correctAnswer) {
            return toast( "You Are Right" );
          }
          return toast("You Are Wrong");
            ...
            <div className="box border rounded-lg m-20  text-center pt-5 relative ">
...

                {
                    qui.options.map(option=>(
                        <div option={option} className="mt-5 flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
